...
// Vector Implentation from frigg
// github.com/managarm/frigg
// License: MIT
...
template <typename T>
template <typename... Args>
void vector<T>::resize(size_t new_size, Args&&... args)
{
...
template <typename T>
void vector<T>::_ensure_capacity(size_t capacity)
{
    if (capacity <= _capacity)
        return;

    size_t new_capacity = capacity * 2;
    T* new_array = (T*)mm::alloc(sizeof(T) * new_capacity);
